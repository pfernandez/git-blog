...
var hljsGrammar = function () {
  ...
  return function (e) {
    var r = e.regex,
        ...
        n = ["bigint", "binary", "blob", "boolean", "char", "character", "clob", "date", "dec", "decfloat", "decimal", "float", "int", "integer", "interval", "nchar", "nclob", "national", "numeric", "real", "row", "smallint", "time", "timestamp", "varchar", "varying", "varbinary"],
      ...
      keywords: {
        ...
        keyword: function (e) {
          ...
          return r = r || [], e.map(function (e) {
            return e.match(/\|\d+$/) || r.includes(e) ? e : a(e) ? e + "|0" : e;
          });
        }(c, {
