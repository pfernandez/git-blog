  ...
  function o(o) {
    var l = o.regex,
      ...
      variants: [o.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
        ...
        N = [o.APOS_STRING_MODE, o.QUOTE_STRING_MODE, A, f, _, E];
    y.contains = N.concat({
      begin: /\{/,
      end: /\}/,
      keywords: g,
    ...
    var h = [].concat(p, y.contains),
      ...
      illegal: /%/
        ...
        k = {
      match: l.concat(/\b/, (O = [].concat(r, ["super"]), l.concat("(?!", O.join("|"), ")")), d, l.lookahead(/\(/)),
    ...
    return {
      ...
      }, o.APOS_STRING_MODE, o.QUOTE_STRING_MODE, A, f, _, p, E, R, {
        className: "attr",
        begin: d + l.lookahead(":"),
        relevance: 0
      }, M, {
