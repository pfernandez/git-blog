...
var hljsGrammar = function () {
  ...
  return function (e) {
    var t = e.regex,
        r = "[a-zA-Z0-9_\x7f-\xff]*(?![A-Za-z0-9])(?![$]))",
        a = t.concat("([a-zA-Z_\\x7f-\\xff]", r),
        n = t.concat("([A-Z]", r),
        o = {
      scope: "variable",
      match: "\\$+" + a
      ...
      scope: {
        ...
        m = {
      variants: [{
        match: [t.concat(/::/, t.lookahead(/(?!class\b)/)), I],
        scope: {
          2: "variable.constant"
        }
      }, {
    ...
    return {
      ...
      contains: [e.HASH_COMMENT_MODE, e.COMMENT("//", "$"), e.COMMENT("/\\*", "\\*/", {
        ...
        contains: [{
          ...
          excludeEnd: !0,
          keywords: b,
          contains: ["self", o, m, e.C_BLOCK_COMMENT_MODE, s, p]
        }]
      }, {
        scope: "class",
        variants: [{
