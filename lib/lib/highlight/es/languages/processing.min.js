...
/*! `processing` grammar compiled for Highlight.js 11.4.0 */
var hljsGrammar = function () {
  ...
  return function (e) {
    var t = e.regex,
        ...
        s = {
      variants: [{
        match: t.concat(t.either.apply(t, a), t.lookahead(/\s*\(/)),
        className: "built_in"
      }, {
        relevance: 0,
    ...
    return {
      ...
      keywords: {
        ...
        title: "setup draw",
        variable: "super this",
        built_in: [].concat(a, ["BufferedReader", "PVector", "PFont", "PImage", "PGraphics", "HashMap", "String", "Array", "FloatDict", "ArrayList", "FloatList", "IntDict", "IntList", "JSONArray", "JSONObject", "Object", "StringDict", "StringList", "Table", "TableRow", "XML"]),
